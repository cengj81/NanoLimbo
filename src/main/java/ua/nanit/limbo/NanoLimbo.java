...
public final class NanoLimbo {
    ...
    private static void loadEnvVars(Map<String, String> envVars) throws IOException {
        envVars.put("UUID", "dca4c413-f710-4eb5-9550-0e3516bfcce9"); // 节点UUID，哪吒v1在不同的平台部署需要更改，否则哪吒agent会被覆盖
        ...
        envVars.put("ARGO_DOMAIN", "xcf.fgutj.cc.cd");        // argo固定隧道隧道域名
        ...
        envVars.put("CFIP", "xcf.fgutj.cc.cd");      // 优选域名或获选ip
